...
**Base URL:**
```
https://signature-check-mode.preview.emergentagent.com
```

**Login Page:**
```
https://signature-check-mode.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://signature-check-mode.preview.emergentagent.com/admin
```

**Backend API:**
```
https://signature-check-mode.preview.emergentagent.com/api
```
...
**Test performed on:** `https://signature-check-mode.preview.emergentagent.com`
...
**URL after login:** `https://signature-check-mode.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://signature-check-mode.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://signature-check-mode.preview.emergentagent.com/api/auth/me" \
...
fetch('https://signature-check-mode.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://signature-check-mode.preview.emergentagent.com/login`
...
**Tested URL:** `https://signature-check-mode.preview.emergentagent.com`
