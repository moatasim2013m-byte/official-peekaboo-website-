...
**Base URL:**
```
https://playdate-hub.preview.emergentagent.com
```

**Login Page:**
```
https://playdate-hub.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://playdate-hub.preview.emergentagent.com/admin
```

**Backend API:**
```
https://playdate-hub.preview.emergentagent.com/api
```
...
**Test performed on:** `https://playdate-hub.preview.emergentagent.com`
...
**URL after login:** `https://playdate-hub.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://playdate-hub.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://playdate-hub.preview.emergentagent.com/api/auth/me" \
...
fetch('https://playdate-hub.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://playdate-hub.preview.emergentagent.com/login`
...
**Tested URL:** `https://playdate-hub.preview.emergentagent.com`
