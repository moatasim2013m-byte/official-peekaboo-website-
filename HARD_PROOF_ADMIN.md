...
**Base URL:**
```
https://financedefend.preview.emergentagent.com
```

**Login Page:**
```
https://financedefend.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://financedefend.preview.emergentagent.com/admin
```

**Backend API:**
```
https://financedefend.preview.emergentagent.com/api
```
...
**Test performed on:** `https://financedefend.preview.emergentagent.com`
...
**URL after login:** `https://financedefend.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://financedefend.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://financedefend.preview.emergentagent.com/api/auth/me" \
...
fetch('https://financedefend.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://financedefend.preview.emergentagent.com/login`
...
**Tested URL:** `https://financedefend.preview.emergentagent.com`
