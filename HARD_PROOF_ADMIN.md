...
**Base URL:**
```
https://reset-link-repair.preview.emergentagent.com
```

**Login Page:**
```
https://reset-link-repair.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://reset-link-repair.preview.emergentagent.com/admin
```

**Backend API:**
```
https://reset-link-repair.preview.emergentagent.com/api
```
...
**Test performed on:** `https://reset-link-repair.preview.emergentagent.com`
...
**URL after login:** `https://reset-link-repair.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://reset-link-repair.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://reset-link-repair.preview.emergentagent.com/api/auth/me" \
...
fetch('https://reset-link-repair.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://reset-link-repair.preview.emergentagent.com/login`
...
**Tested URL:** `https://reset-link-repair.preview.emergentagent.com`
