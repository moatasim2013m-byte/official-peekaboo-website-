...
**Base URL:**
```
https://peekaboo-tickets.preview.emergentagent.com
```

**Login Page:**
```
https://peekaboo-tickets.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://peekaboo-tickets.preview.emergentagent.com/admin
```

**Backend API:**
```
https://peekaboo-tickets.preview.emergentagent.com/api
```
...
**Test performed on:** `https://peekaboo-tickets.preview.emergentagent.com`
...
**URL after login:** `https://peekaboo-tickets.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://peekaboo-tickets.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://peekaboo-tickets.preview.emergentagent.com/api/auth/me" \
...
fetch('https://peekaboo-tickets.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://peekaboo-tickets.preview.emergentagent.com/login`
...
**Tested URL:** `https://peekaboo-tickets.preview.emergentagent.com`
