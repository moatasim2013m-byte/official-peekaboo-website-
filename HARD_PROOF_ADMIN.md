...
**Base URL:**
```
https://peekaboo-play.preview.emergentagent.com
```

**Login Page:**
```
https://peekaboo-play.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://peekaboo-play.preview.emergentagent.com/admin
```

**Backend API:**
```
https://peekaboo-play.preview.emergentagent.com/api
```
...
**Test performed on:** `https://peekaboo-play.preview.emergentagent.com`
...
**URL after login:** `https://peekaboo-play.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://peekaboo-play.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://peekaboo-play.preview.emergentagent.com/api/auth/me" \
...
fetch('https://peekaboo-play.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://peekaboo-play.preview.emergentagent.com/login`
...
**Tested URL:** `https://peekaboo-play.preview.emergentagent.com`
