...
**Base URL:**
```
https://payment-debug-28.preview.emergentagent.com
```

**Login Page:**
```
https://payment-debug-28.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://payment-debug-28.preview.emergentagent.com/admin
```

**Backend API:**
```
https://payment-debug-28.preview.emergentagent.com/api
```
...
**Test performed on:** `https://payment-debug-28.preview.emergentagent.com`
...
**URL after login:** `https://payment-debug-28.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://payment-debug-28.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://payment-debug-28.preview.emergentagent.com/api/auth/me" \
...
fetch('https://payment-debug-28.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://payment-debug-28.preview.emergentagent.com/login`
...
**Tested URL:** `https://payment-debug-28.preview.emergentagent.com`
