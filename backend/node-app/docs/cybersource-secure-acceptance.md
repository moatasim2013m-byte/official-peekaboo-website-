...
- `CAPITAL_BANK_PAYMENT_ENDPOINT=https://testsecureacceptance.cybersource.com` (optional explicit override; alias: `CAPITAL_BANK_ENDPOINT`; use base URL only, backend appends `/pay`)
