...
import { ChevronLeft, Clock, Cake, Star, Sun, Moon } from 'lucide-react';

export default function PricingPage() {
  useEffect(() => {
    document.title = 'الأسعار | بيكابو';
  }, []);
    ...
    <div className="min-h-screen py-8 md:py-12" dir="rtl">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <h1 className="font-heading text-3xl sm:text-4xl font-bold text-foreground mb-2">الأسعار</h1>
          <p className="text-muted-foreground">أسعار شفافة ومناسبة للجميع</p>
        </div>
