    ...
    <div className="min-h-screen py-8 md:py-12" dir="rtl">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[var(--pk-orange)] mb-4 shadow-lg">
            <Home className="h-10 w-10 text-white" />
          </div>
          <h1 className="font-heading text-3xl sm:text-4xl font-bold text-foreground mb-2" data-testid="home-party-title">
            حفلتك في بيتك
          </h1>
          <p className="text-muted-foreground">
            نأتيكم للمنزل مع ديكور واحتفال كامل لطفلك
          </p>
        </div>
